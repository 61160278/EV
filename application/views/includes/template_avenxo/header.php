...
<head>
    ...
    <link type="text/css" href="<?php echo base_url();?>avenxo/assets/fonts/themify-icons/themify-icons.css" rel="stylesheet">              <!-- Themify Icons -->
    <link type="text/css" href="<?php echo base_url();?>avenxo/assets/css/styles.css" rel="stylesheet">                                     <!-- Core CSS with all styles -->
