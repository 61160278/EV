...
class Da_evs_data_mbo_approve extends evs_model {		
	...
	*/
	...
	function insert() {
	 	...
	 	$sql = "INSERT INTO evs_database.evs_data_mbo_approve (dma_approve1	,dma_approve2,dma_dtm_emp_id)
	 	VALUES(?,?,?)";
		 
	 	$this->db->query($sql, array($this->dma_approve1	, $this->dma_approve2, $this->dma_dtm_emp_id));
	 }
	...
	*/
	...
	function update() {
		...
		$this->db->query($sql, array($this->dma_approve1, $this->dma_approve2, $this->dma_dtm_emp_id, $this->dma_id));
