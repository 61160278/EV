...
class Da_evs_data_g_and_o extends evs_model {		
	...
	*/
	...
	function insert() {
	 	...
	 	$sql = "INSERT INTO evs_database.evs_data_g_and_o (dgo_type, dgo_sdgs, dgo_item, dgo_weight, dgo_emp_id, dgo_evs_emp_id)
	 	VALUES(?,?,?,?,?,?)";
		 
	 	$this->db->query($sql, array( $this->dgo_type, $this->dgo_sdgs, $this->dgo_item, $this->dgo_weight, $this->dgo_emp_id, $this->dgo_evs_emp_id));
	 }
