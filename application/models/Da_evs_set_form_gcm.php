...
class Da_evs_set_form_gcm extends evs_model {		
	...
	public $sgc_cpn_id; //Competency Sequence	
	...
	* @input sgc_weight, sgc_pos_id, sgc_cpn_id, sgc_pay_id
	* @output -
	* @author Jakkarin Pimpaeng
	* @Create Date 2563-09-28
	*/
	...
	*/
	function insert() {
	 	...
	 	$sql = "INSERT INTO evs_database.evs_set_form_gcm (sgc_weight, sgc_pos_id, sgc_cpn_id, sgc_pay_id)
	 			VALUES( ?, ?, ?, ?)";
		 
	 	$this->db->query($sql, array($this->sgc_weight, $this->sgc_pos_id, $this->sgc_cpn_id, $this->sgc_pay_id));
	...
	* @input sgc_id, sgc_weight, sgc_pay_id, sgc_pos_id, sgc_cpn_id
	* @output -
	* @author Jakkarin Pimpaeng
	* @Create Date 2563-09-28
	*/
	...
	*/
	function update() {
	 	$sql = "UPDATE evs_database.evs_set_form_gcm 
	 			SET	sgc_weight=?, sgc_pay_id=? sgc_pos_id=? sgc_cpn_id=?  
	 			WHERE sgc_pos_id=?";
	 	$this->db->query($sql, array($this->sgc_id, $this->sgc_weight, $this->sgc_pay_id, $this->sgc_pos_id, $this->sgc_cpn_id));
	...
	* @input sgc_id
	* @output sgc_id, sgc_weight, sgc_pay_id, sgc_pos_id, sgc_cpn_id
	* @author Jakkarin Pimpaeng
	* @Create Date 2563-09-28
	*/
	/*
